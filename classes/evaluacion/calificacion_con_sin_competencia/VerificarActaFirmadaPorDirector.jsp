...
{		
	...
	ent.verificarTieneEnvioDeActaPorDirector(intTipoActa);   //-->>Verificar si ya se envio acta a escoleres (YA ADJUNTO ANTES EL DIRECTOR)
	//Se crea un objeto tipo json (objeto de javascript)
	JSONObject json = new JSONObject();
	//--Inicio de despliegue de campos
    json.put("intTieneFirmaActa", ent.intTieneFirmaActa); 
    json.put("intTieneEnvioDeActaPorDir", ent.intTieneEnvioDeActaPorDir); 	
